    ...
    document.getElementById("header-lang-img") &&
      ("en" == t
        ? (document.getElementById("header-lang-img").src =
          "admin/assets/images/flags/us.jpg")
        : "sp" == t
          ? (document.getElementById("header-lang-img").src =
            "admin/assets/images/flags/spain.jpg")
          : "gr" == t
            ? (document.getElementById("header-lang-img").src =
              "admin/assets/images/flags/germany.jpg")
            : "it" == t
              ? (document.getElementById("header-lang-img").src =
                "admin/assets/images/flags/italy.jpg")
              : "ru" == t &&
              (document.getElementById("header-lang-img").src =
                "admin/assets/images/flags/russia.jpg"),
        localStorage.setItem("minia-language", t),
        null == (r = localStorage.getItem("minia-language")) && i(o),
        a.getJSON("admin/assets/lang/" + r + ".json", function (t) {
          a("html").attr("lang", r),
      ...
      "ltr" == a(this).val()
        ? (document.getElementsByTagName("html")[0].removeAttribute("dir"),
          document
            ...
            .setAttribute("href", "admin/assets/css/bootstrap.min.css"),
          document
            .getElementById("app-style")
            .setAttribute("href", "admin/assets/css/app.min.css"))
        : (document
          .getElementById("bootstrap-style")
          .setAttribute("href", "admin/assets/css/bootstrap-rtl.min.css"),
          document
            .getElementById("app-style")
            .setAttribute("href", "admin/assets/css/app-rtl.min.css"),
